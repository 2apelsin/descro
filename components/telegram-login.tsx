...
export function TelegramLogin() {
  ...
  const handleTelegramLogin = () => {
    ...
    alert('Откройте Telegram бот и нажмите "Start". После этого вернитесь на сайт и обновите страницу.')
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center gap-2 rounded-lg bg-[#0088cc] px-4 py-2 text-sm font-medium text-white hover:bg-[#0077b3] disabled:opacity-50"
    >
