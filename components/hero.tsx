...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-12 sm:pb-24 sm:pt-20 md:px-6 md:pb-32 md:pt-28">
        <div className="grid gap-8 sm:gap-12 lg:grid-cols-[1.1fr_1fr] lg:gap-16 lg:items-start">
          {/* Левая колонка */}
          <div className="space-y-6 sm:space-y-8 text-white">
            {/* Бейдж */}
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs sm:text-sm backdrop-blur-sm">
            ...
            <div className="inline-flex flex-col sm:flex-row items-start sm:items-center gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-3 backdrop-blur-sm">
              <div>
                <div className="flex items-baseline gap-2">
                  <span className="text-xl sm:text-2xl font-bold text-emerald-400">199 ₽</span>
                  <span className="text-base sm:text-lg text-white/50 line-through">299 ₽</span>
                </div>
                <div className="text-xs sm:text-sm text-white/80">Первый месяц со скидкой</div>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-8 pt-2 sm:pt-4">
              <div>
                <div className="text-2xl sm:text-3xl font-bold">10 сек</div>
                <div className="text-xs sm:text-sm text-white/60">Генерация</div>
              </div>
              <div className="h-10 sm:h-12 w-px bg-white/10" />
              <div>
                <div className="text-2xl sm:text-3xl font-bold">100+</div>
                <div className="text-xs sm:text-sm text-white/60">Карточек в день</div>
              </div>
              <div className="h-10 sm:h-12 w-px bg-white/10" />
              <div>
                <div className="text-2xl sm:text-3xl font-bold">3 блока</div>
                <div className="text-xs sm:text-sm text-white/60">Готового текста</div>
              </div>
            </div>
